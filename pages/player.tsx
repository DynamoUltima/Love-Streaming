...
const Player = () => {
    ...
    return (
        ...
        <div className="bg-grayblack h-screen  grid grid-cols-6  w-full ">

            {/* Side bar */}
            <div className="hidden md:flex h-screen overflow-clip col-span-1 ">
                <SideNav />
            </div>
            
            <div className="md:col-span-5 overflow-auto  col-span-6">
                <Navbar />
