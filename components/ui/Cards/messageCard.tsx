    ...
    return (
        <>
            <div onClick={handleClick} className='flex flex-col space-y-2'>
                {/* Image */}
                <div className='relative   aspect-video bg-white rounded-lg overflow-clip  shadow-lg mb-4'>
                    <Image alt='Card Image' layout="fill"  src={image} objectFit="cover" />
                </div>
                {/* Text */}
                <div className='flex flex-col space-y-1'>
                    <div className='text-gray-50 text-[15px]  truncate '>{name}</div>
                    <div className='text-gray-400 opacity-[.5] text-[12px]'>2 days ago</div>
                </div>
